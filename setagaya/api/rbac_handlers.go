...
func (s *SetagayaAPI) rolesGetHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
...
func (s *SetagayaAPI) roleGetHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
...
func (s *SetagayaAPI) roleCreateHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	var req struct {
...
func (s *SetagayaAPI) roleUpdateHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	roleIDStr := params.ByName("role_id")
	roleID, err := strconv.ParseInt(roleIDStr, 10, 64)
	if err != nil {
		s.handleErrors(w, makeBadRequestError("Invalid role ID"))
...
func (s *SetagayaAPI) roleDeleteHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	roleIDStr := params.ByName("role_id")
	roleID, err := strconv.ParseInt(roleIDStr, 10, 64)
	if err != nil {
		s.handleErrors(w, makeBadRequestError("Invalid role ID"))
...
func (s *SetagayaAPI) permissionsGetHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
...
func (s *SetagayaAPI) permissionGetHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
...
func (s *SetagayaAPI) permissionCreateHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	var req struct {
		Name        string `json:"name"`
...
func (s *SetagayaAPI) usersGetHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
...
func (s *SetagayaAPI) userGetHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
...
func (s *SetagayaAPI) userCreateHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	var req struct {
...
func (s *SetagayaAPI) userUpdateHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	userIDStr := params.ByName("user_id")
	userID, err := strconv.ParseInt(userIDStr, 10, 64)
	if err != nil {
		s.handleErrors(w, makeBadRequestError("Invalid user ID"))
...
func (s *SetagayaAPI) userDeleteHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	userIDStr := params.ByName("user_id")
	userID, err := strconv.ParseInt(userIDStr, 10, 64)
	if err != nil {
		s.handleErrors(w, makeBadRequestError("Invalid user ID"))
...
func (s *SetagayaAPI) userRolesGetHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	userIDStr := params.ByName("user_id")
	userID, err := strconv.ParseInt(userIDStr, 10, 64)
	if err != nil {
		s.handleErrors(w, makeBadRequestError("Invalid user ID"))
...
func (s *SetagayaAPI) userRoleAssignHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	userIDStr := params.ByName("user_id")
	userID, err := strconv.ParseInt(userIDStr, 10, 64)
	if err != nil {
		s.handleErrors(w, makeBadRequestError("Invalid user ID"))
...
func (s *SetagayaAPI) userRoleRemoveHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	userIDStr := params.ByName("user_id")
	userID, err := strconv.ParseInt(userIDStr, 10, 64)
	if err != nil {
		s.handleErrors(w, makeBadRequestError("Invalid user ID"))
...
func (s *SetagayaAPI) userPermissionsGetHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	userIDStr := params.ByName("user_id")
	userID, err := strconv.ParseInt(userIDStr, 10, 64)
	if err != nil {
		s.handleErrors(w, makeBadRequestError("Invalid user ID"))
...
func (s *SetagayaAPI) currentUserHandler(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
	rbacUser := GetRBACUserFromContext(r)
	if rbacUser == nil {
