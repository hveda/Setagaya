...
func (s *SetagayaAPI) InputValidationMiddleware(next httprouter.Handle) httprouter.Handle {
...
func (s *SetagayaAPI) validateRequestBody(r *http.Request) error {
...
func (s *SetagayaAPI) validateJSONContent(path string, data interface{}) error {
	switch {
