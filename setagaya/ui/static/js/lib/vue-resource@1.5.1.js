...
!(function (t, e) {
      ...
      r(function () {
        if (2 !== i.state)
          for (; i.deferred.length; ) {
            ...
            try {
              0 === i.state
                ? o('function' == typeof e ? e.call(void 0, i.value) : i.value)
                : 1 === i.state && ('function' == typeof n ? o(n.call(void 0, i.value)) : r(i.value));
            } catch (t) {
              r(t);
            }
          }
  ...
  function x(t, e, n) {
    for (var o in e)
      n && (y(e[o]) || h(e[o]))
        ? (y(e[o]) && !y(t[o]) && (t[o] = {}), h(e[o]) && !h(t[o]) && (t[o] = []), x(t[o], e[o], n))
        : void 0 !== e[o] && (t[o] = e[o]);
  }
  function j(t, e, n) {
    var o,
      ...
      root: function (t, e) {
        ...
        return (
          d(t.root) &&
            ...
            (o = '/'),
            (r =
              (n && void 0 === o ? n.replace(/\s+$/, '') : n && o ? n.replace(new RegExp('[' + o + ']+$'), '') : n) +
              '/' +
              r)),
          r
        );
  ...
  function S(s) {
    ...
    return new c(function (e) {
      ...
      (s.headers.forEach(function (t, e) {
        ...
        u(t, { body: o, method: r, headers: i }).then(
          (n = function (t) {
  ...
  var H = function (t) {
    ...
    ((this.body = null),
      (this.params = {}),
      w(this, t, { method: ((e = t.method || 'GET'), e ? e.toUpperCase() : '') }),
    ...
    (M.interceptor = {
      ...
      method: function (t) {
        t.emulateHTTP &&
          ...
          (t.headers.set('X-HTTP-Method-Override', t.method), (t.method = 'POST'));
      },
      jsonp: function (t) {
          ...
          function (o) {
            return o.bodyText
              ? v(o.text(), function (t) {
                  var e, n;
                  if (
                    0 === (o.headers.get('Content-Type') || '').indexOf('application/json') ||
                    ((n = (e = t).match(/^\s*(\[|\{)/)) && { '[': /]\s*$/, '{': /}\s*$/ }[n[1]].test(e))
                  )
                    try {
                      o.body = JSON.parse(t);
                    } catch (t) {
