...
validate_sarif() {
    ...
    jq --arg tool_name "$tool_name" '
        ...
        .runs[] |= (
            ...
            if .tool.driver.informationUri then . else .tool.driver.informationUri = "https://github.com/heridotlife/honryu" end |
            .results[]? |= (
  ...
  "runs": [
    {
      "tool": {
        "driver": {
          "name": "$tool_name",
          "version": "1.0.0",
          "informationUri": "https://github.com/heridotlife/honryu"
        }
      },
      "results": []
    }
