...
import (
	...
	k8sadapter "github.com/heridotlife/Setagaya/v3/internal/adapters/scheduler/k8s"
	"github.com/heridotlife/Setagaya/v3/internal/domain/engine"
	"github.com/heridotlife/Setagaya/v3/internal/ports"
	"github.com/heridotlife/Setagaya/v3/internal/ports/schedulertest"
)
...
func TestK8sScheduler_StatusCountsOnlyReadyPods(t *testing.T) {
	...
	status, err := s.CollectionStatus(ctx, 2, []ports.PlanRef{{PlanID: 3, Engines: 3}})
	if err != nil {
