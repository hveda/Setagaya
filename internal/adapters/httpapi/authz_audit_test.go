...
var authzAuditTable = []authzEntry{
	...
	{method: "GET", pattern: "/api/projects/{project_id}", decision: "project:read", pending: "task 9"},
	...
	{method: "GET", pattern: "/api/scenarios/{scenario_id}", decision: "scenario:read", pending: "task 9"},
	{method: "DELETE", pattern: "/api/scenarios/{scenario_id}", decision: "scenario:delete"},
	{method: "GET", pattern: "/api/scenarios/{scenario_id}/files", decision: "scenario:read", pending: "task 9"},
	...
	{method: "GET", pattern: "/api/executions/{execution_id}/files", decision: "execution:read", pending: "task 9"},
	...
	{method: "GET", pattern: "/api/executions/{execution_id}/config", decision: "execution:read", pending: "task 9"},
	...
	{method: "GET", pattern: "/api/executions/{execution_id}/status", decision: "execution:read", pending: "task 9"},
	{method: "GET", pattern: "/api/executions/{execution_id}/engines", decision: "execution:read", pending: "task 9"},
	{method: "GET", pattern: "/api/executions/{execution_id}/scenarios/{scenario_id}/logs", decision: "execution:read", pending: "task 9"},
