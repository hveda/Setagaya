...
func (s *ShibuyaAPI) rbacRequired(next httprouter.Handle) httprouter.Handle {
...
func (s *ShibuyaAPI) requirePermission(permission string) func(httprouter.Handle) httprouter.Handle {
...
func (s *ShibuyaAPI) requireResourcePermission(resource, action string) func(httprouter.Handle) httprouter.Handle {
	return func(next httprouter.Handle) httprouter.Handle {
		return s.rbacRequired(func(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
			rbacUser := r.Context().Value(userContextKey).(*RBACUser)
...
func (s *ShibuyaAPI) requireRole(roleName string) func(httprouter.Handle) httprouter.Handle {
	return func(next httprouter.Handle) httprouter.Handle {
		return s.rbacRequired(func(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
			rbacUser := r.Context().Value(userContextKey).(*RBACUser)
...
func (s *ShibuyaAPI) requireAdminRole(next httprouter.Handle) httprouter.Handle {
	return s.rbacRequired(func(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
		rbacUser := r.Context().Value(userContextKey).(*RBACUser)
...
func (s *ShibuyaAPI) projectOwnershipRequired(next httprouter.Handle) httprouter.Handle {
	return s.rbacRequired(func(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
		rbacUser := r.Context().Value(userContextKey).(*RBACUser)
...
func (s *ShibuyaAPI) collectionOwnershipRequired(next httprouter.Handle) httprouter.Handle {
	return s.rbacRequired(func(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
		rbacUser := r.Context().Value(userContextKey).(*RBACUser)
