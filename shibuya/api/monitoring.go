...
func (s *ShibuyaAPI) LoggingMiddleware(next httprouter.Handle) httprouter.Handle {
...
func (s *ShibuyaAPI) MonitoringMiddleware(next httprouter.Handle) httprouter.Handle {
	return httprouter.Handle(func(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
		start := time.Now()
...
func (s *ShibuyaAPI) RecoveryMiddleware(next httprouter.Handle) httprouter.Handle {
	return httprouter.Handle(func(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
		defer func() {
...
func (s *ShibuyaAPI) TimeoutMiddleware(timeout time.Duration) func(httprouter.Handle) httprouter.Handle {
...
func (s *ShibuyaAPI) CombinedMonitoringMiddleware(next httprouter.Handle) httprouter.Handle {
...
func (s *ShibuyaAPI) HealthCheckHandler() httprouter.Handle {
	return httprouter.Handle(func(w http.ResponseWriter, r *http.Request, params httprouter.Params) {
